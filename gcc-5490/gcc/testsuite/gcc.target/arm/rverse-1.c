/* APPLE LOCAL file REV/UXTB support */
/* { dg-do compile } */
/* This does not pass at -O0, but should at anything higher.  Unfortunately
   dg-skip-if "-O0", which is what I'd like to do, does not work in gcc.c-torture. */
/* { dg-options "-O1 -march=armv6 -std=gnu99" } */
/* Test for generation of "rev" instruction. */
...
/* { dg-final { scan-assembler-times "\\\trev" 9 } } */
