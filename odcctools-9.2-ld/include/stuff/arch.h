...
extern unsigned long get_shared_region_sz_from_flag(const struct
    arch_flag *cputype);
 ...
 */
extern long get_stack_direction_from_flag(
    const struct arch_flag *flag);
 ...
 */
extern unsigned long get_stack_size_from_flag(
    const struct arch_flag *flag);

/*
 * get_segalign_from_flag() returns the default segment alignment (page size).
 */
extern unsigned long get_segalign_from_flag(
    const struct arch_flag *flag);
